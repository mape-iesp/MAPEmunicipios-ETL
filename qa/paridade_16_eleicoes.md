...
| `proporcao_votos_nulos_prefeitura` | b_renomeacao | renomeada para 'proporcao_votos_brancos_prefeito_pct' |
| `proporcao_votos_nulos` | b_renomeacao | renomeada para 'proporcao_votos_nulos_prefeito_pct' |
| `proporcao_comparecimento_camara_vereadores` | b_renomeacao | renomeada para 'comparecimento_camara_pct' |
| `prefeito_eleito` | b_renomeacao | renomeada para 'nome_urna_prefeito_eleito' |
| `partido` | b_renomeacao | renomeada para 'sigla_partido_prefeito_eleito' |
...
| `sg_partido_governador_segundo_lugar` | b_renomeacao | renomeada para 'sigla_partido_governador_segundo_colocado' |
