...
| `impostos_pib` | b_renomeacao | renomeada para 'razao_impostos_sobre_pib_prop' |
...
| `log_pib` | b_renomeacao | renomeada para 'ln_pib_brl2023' |
| `log_pib_per_capita` | b_renomeacao | renomeada para 'ln_pib_per_capita_brl2023' |
| `log_valor_adicionado` | b_renomeacao | renomeada para 'ln_valor_adicionado_bruto_brl2023' |
