...
CONFIG <- list(
  ...
  "04_economia" = list(
    ...
    observacoes = paste(
      ...
      "denominador, que o legado descarta depois da junção. Isso torna a",
      "coluna não reproduzível a partir da base publicada. Ao reextrair, o",
      "cálculo deve passar a usar 02_populacao explicitamente.",
